    ...
    fetch(`https://api.github.com/repos/Technigo/${repo.name}/pulls?per_page=100`)
      ...
      .then(pullRequests => {
        ...
        const myPullRequests = pullRequests
          .filter(pullRequest => pullRequest.user.login === username || pullRequest.title === firstTitleToSearchFor || pullRequest.title === secondTitleToSearchFor || pullRequest.title === thirdTitleToSearchFor || pullRequest.title === fourthTitleToSearchFor || pullRequest.title === fifthTitleToSearchFor)
