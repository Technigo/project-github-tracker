            ...
            forkedRepos.forEach((repo) => {
                projectsContainer.innerHTML += `
                    <div class= each-project>
                        <a class= "project-names-with-pr" href="${repo.html_url}" target="_blank">${repo.name}</a>
...
{/* <p class= "commits-amount"id="commit-${repo.name}"> </p> */}
...
const fetchCommits = (myCommitsUrl, myRepoName) => {
    fetch(myCommitsUrl)
        ...
        .then((data) => {
            ...
            ` <p class= commits-info> Number of commits: ${data.length} </p> `
